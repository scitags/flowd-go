...
%changelog
* Thu Dec 11 2025 Pablo Collado Soto <pablo.collado.soto@cern.ch> - 2.4.1-1
- Don't fail when no private addresses are found with stun enabled

* Mon Dec 8 2025 Pablo Collado Soto <pablo.collado.soto@cern.ch> - 2.4.0-1
- Add STUN support for the firefly backend

* Thu Dec 4 2025 Pablo Collado Soto <pablo.collado.soto@cern.ch> - 2.3.1-1
- Update default configuration paths

* Thu Dec 4 2025 Pablo Collado Soto <pablo.collado.soto@cern.ch> - 2.3.0-1
- Pull changes shown to work at SuperComputing 25
- Migrate from libbpf and libbpf-go to cilium/ebpf
- Pull TCP information through eBPF
- Unify sock_diag(7) and eBPF TCP information data sources
- Expose TCP information in a Prometheus-compatible fashion
- Allow YAML for defining configurations
- Propagate the application name in fireflies
- Propagate IP family in flowIDs generated by the np plugin
